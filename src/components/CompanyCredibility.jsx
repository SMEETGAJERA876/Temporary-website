...
const metrics = [
  ...
  { target: 14, suffix: '+', label: 'Industries Served' },
...
export default function CompanyCredibility() {
  return (
    <section className="py-28 md:py-36 px-6 md:px-8 bg-white font-sans text-center border-t border-[#E2E6EF] relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 text-left relative z-10">
        {metrics.map((m) => (
          <div key={m.label}>
